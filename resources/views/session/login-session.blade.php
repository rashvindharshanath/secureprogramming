            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <p class="mb-0">Sign in to your account to access our services online<br></p>
                ...
                <a href="{{ url('login/google')}}" >
                  <span class="btn-inner--icon"><img src="https://developers.google.com/identity/images/btn_google_signin_dark_normal_web.png"></span>
                </a>
                </div>
