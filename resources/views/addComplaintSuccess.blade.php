...
@section('content')
<title>
    Complaint submited successfully
  </title>
<div>
    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                ...
                <p class="py-5">Your complaint has been submited. Thank you for your feedback!</p>
                <p class="py-5">We will get back to you as soon as possible.</p>
