...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  @if (Auth::user()->role == 'admin')
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ url('dashboard') }}" style="background-color: thistle">
        <img src="../assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="...">
        <span class="ms-3 font-weight-bold">Communicare Admin Dashboard</span>
    </a>
    @else 
    <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ url('dashboard') }}" style="background-color: thistle">
        <img src="../assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="...">
        <span class="ms-3 font-weight-bold">Communicare User Dashboard</span>
    </a>
@endif
...
@if (Auth::user()->role == 'admin')
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main" style="background-color: thistle"> 
    <ul class="navbar-nav">
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('complaints') ? 'active' : '') }}" href="{{ url('complaints') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('additem') ? 'active' : '') }}" href="{{ url('additem') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <span class="nav-link-text ms-1">Add Facilities</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('QRconfirmBooking') ? 'active' : '') }}" href="{{ url('QRconfirmBooking') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>settings</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Confirm Bookings</span>
        </a>
      </li>
    </ul>
  </div>
